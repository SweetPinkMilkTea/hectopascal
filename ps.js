...
const mod_full = {
    "SU": "Sensory Underload",
    "BL": "Bargainless",
    "PF": "Perfect",
    "CP": "Cleithrophobia-phobia",
    "SA": "Safety Averse",
    "AN": "Anchored",
    "HA": "Hyperactive",
    "LO": "Lock-On",
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function stopWatchUpdate() {
        if (timerIsRunning) {
            ...
            document.getElementById('timedisplay').innerHTML = m.toLocaleString('en-US', {
